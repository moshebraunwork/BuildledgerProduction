    ...
    <>
          ...
          <Card key={r.id}>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                {!r.is_system && <Button variant="ghost" size="sm" onClick={() => remove(r)}><Trash2 className="h-3.5 w-3.5" /> Delete</Button>}
              </div>
            </CardContent>
          </Card>
        ))}
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader><DialogTitle>{editing ? `Edit "${editing.name}"` : "New role"}</DialogTitle></DialogHeader>
